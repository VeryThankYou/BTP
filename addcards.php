...
if(!isset($_SESSION['listtoadd'])){
  header('location: main.php');  
  //Check if we have a session variable called listtoadd. This way we block users from changing the url, and this page doesn't work without that session variable.
}
